...
import com.btweeu.server.data.repository.RefreshTokenStatus
...
import com.btweeu.server.dto.AuthResponse
import com.btweeu.server.dto.RegistrationPendingResponse
import com.btweeu.server.dto.ChangePasswordRequest
import org.jetbrains.exposed.sql.insert
import org.jetbrains.exposed.sql.transactions.transaction
import com.btweeu.server.dto.ForgotPasswordRequest
import com.btweeu.server.dto.LoginRequest
import com.btweeu.server.dto.MessageResponse
import com.btweeu.server.dto.OAuthLoginRequest
import com.btweeu.server.dto.RefreshRequest
import com.btweeu.server.dto.RegisterRequest
import com.btweeu.server.dto.TurnstileConfigResponse
import com.btweeu.server.dto.ResetPasswordRequest
import com.btweeu.server.dto.ResendVerificationRequest
import com.btweeu.server.dto.VerifyCodeRequest
import com.btweeu.server.dto.VerifyEmailRequest
import com.btweeu.server.dto.toResponse
import com.btweeu.server.email.EmailSender
...
import com.btweeu.server.plugins.AUTH_RATE_LIMIT
...
import com.btweeu.server.security.OAuthProfile
import com.btweeu.server.security.PasswordHasher
...
// Usernames that could make someone look like Btweeu staff, an official account, or a
...
private val RESERVED_USERNAMES = setOf(
    ...
    "official", "btweeu", "btweeuofficial", "btweeuteam", "btweeusupport", "btweeuapp",
    "btween", "btweenofficial", "btweenteam", "btweensupport", "btweenapp",
    ...
    route("/auth") {
        rateLimit(AUTH_RATE_LIMIT) {
            ...
            post("/register") {
                ...
                emailSender.send(
                    to = user.email,
                    subject = "Verify your Btweeu email",
            ...
            post("/forgot-password") {
                ...
                if (user != null && user.passwordHash != null) {
                    ...
                    emailSender.send(
                        to = user.email,
                        subject = "Your Btweeu password reset code",
